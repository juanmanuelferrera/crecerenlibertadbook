#+TITLE: Crecer en Libertad v.1.1
#+SUBTITLE: Otra forma de aprender es posible
#+AUTHOR: Juan Manuel Ferrera Díaz
#+DATE: Primera Edición, 2025
#+LANGUAGE: es

# =============================================================================
# LaTeX Configuration for 6x9 inch Amazon KDP Book
# =============================================================================
...
# Typography Configuration - Professional Editorial Quality
...
#+LATEX_HEADER:   Scale=MatchLowercase,
#+LATEX_HEADER:   Ligatures=TeX
#+LATEX_HEADER: ]
#+LATEX_HEADER: \newfontfamily\partfont{Libertinus Sans}[
#+LATEX_HEADER:   Scale=1.2,
#+LATEX_HEADER:   LetterSpace=15,
#+LATEX_HEADER:   UprightFont={* Light},
#+LATEX_HEADER:   BoldFont={* SemiBold}
#+LATEX_HEADER: ]
#+LATEX_HEADER: \newfontfamily\chapterfont{Libertinus Serif}[
#+LATEX_HEADER:   Numbers=Lining,
#+LATEX_HEADER:   UprightFont={* SemiBold},
#+LATEX_HEADER:   BoldFont={* Bold}
#+LATEX_HEADER: ]
#+LATEX_HEADER: \usepackage[final,babel=true]{microtype}
#+LATEX_HEADER: \usepackage{setspace}
#+LATEX_HEADER: \setstretch{1.15}     % Professional line spacing for readability
...
# Custom hyphenation dictionary for Spanish unschooling terms
#+LATEX_HEADER: \hyphenation{unschoo-ling homeschoo-ling des-esco-la-ri-zar des-esco-la-ri-za-ción edu-ca-ción so-cia-li-za-ción au-to-no-mía cu-rio-si-dad res-pon-sa-bi-li-dad}
...
#+LATEX_HEADER:       \hb@xt@\@pnumwidth{\hss #2}\par
#+LATEX_HEADER:       \nobreak
...
#+LATEX_HEADER:     \addpenalty{-\@highpenalty}%
#+LATEX_HEADER:     \vskip 0.2em \@plus\p@
#+LATEX_HEADER:     \setlength\@tempdima{1.5em}%
#+LATEX_HEADER:     \begingroup
#+LATEX_HEADER:       \parindent \z@ \rightskip \@pnumwidth
#+LATEX_HEADER:       \parfillskip -\@pnumwidth
#+LATEX_HEADER:       \leavevmode \small
#+LATEX_HEADER:       \advance\leftskip\@tempdima
#+LATEX_HEADER:       \hskip -\leftskip
#+LATEX_HEADER:       #1\nobreak\hfil
#+LATEX_HEADER:       \nobreak\hb@xt@\@pnumwidth{\hss #2}\par
#+LATEX_HEADER:       \penalty\@highpenalty
#+LATEX_HEADER:     \endgroup
#+LATEX_HEADER:   \fi}
#+LATEX_HEADER: \makeatother

# ============================================================================
# MODERN PROFESSIONAL PAGE HEADERS AND NUMBERING SYSTEM
# ============================================================================
# Based on best practices from Penguin Modern Classics, New York Review Books,
# and contemporary literary publishers

# Front matter style: Roman numerals, centered, no headers
#+LATEX_HEADER: \fancypagestyle{frontmatter}{%
#+LATEX_HEADER:   \fancyhf{}%
#+LATEX_HEADER:   \fancyfoot[C]{\small\thepage}%
#+LATEX_HEADER:   \renewcommand{\headrulewidth}{0pt}%
#+LATEX_HEADER:   \renewcommand{\footrulewidth}{0pt}%
#+LATEX_HEADER: }

# Main text style: Running heads with elegant typography
#+LATEX_HEADER: \fancypagestyle{fancy}{%
#+LATEX_HEADER:   \fancyhf{}%
#+LATEX_HEADER:   % Page numbers on outside edges (modern clean look)
#+LATEX_HEADER:   \fancyfoot[LE]{\small\thepage}%
#+LATEX_HEADER:   \fancyfoot[RO]{\small\thepage}%
#+LATEX_HEADER:   % Running heads on inside (verso: author, recto: title)
#+LATEX_HEADER:   \fancyhead[RO]{\small\itshape\nouppercase{\leftmark}}%
#+LATEX_HEADER:   \fancyhead[LE]{\small\itshape Crecer en Libertad}%
#+LATEX_HEADER:   % No rules - clean modern look
#+LATEX_HEADER:   \renewcommand{\headrulewidth}{0pt}%
#+LATEX_HEADER:   \renewcommand{\footrulewidth}{0pt}%
#+LATEX_HEADER: }

# Plain style: Chapter opening pages - only page number, bottom outside
...
# Empty style: Completely blank pages
...
#+LATEX_HEADER: % Custom Part formatting - always start on odd page
#+LATEX_HEADER: \renewcommand{\@part}[2][]{%
#+LATEX_HEADER:   \cleardoublepage%
#+LATEX_HEADER:   \thispagestyle{empty}%
#+LATEX_HEADER:   \null\vfil%
#+LATEX_HEADER:   \secdef\@part\@spart%
#+LATEX_HEADER: }
#+LATEX_HEADER: \def\@part[#1]#2{%
#+LATEX_HEADER:   \ifnum \c@secnumdepth >-2\relax%
#+LATEX_HEADER:     \refstepcounter{part}%
#+LATEX_HEADER:     \addcontentsline{toc}{part}{\thepart\hspace{1em}#1}%
#+LATEX_HEADER:   \else%
#+LATEX_HEADER:     \addcontentsline{toc}{part}{#1}%
#+LATEX_HEADER:   \fi%
#+LATEX_HEADER:   \markboth{}{}%
#+LATEX_HEADER:   {\centering%
#+LATEX_HEADER:    \interlinepenalty \@M%
#+LATEX_HEADER:    \partfont\LARGE\MakeUppercase{#2}\par}%
#+LATEX_HEADER:   \@endpart}
#+LATEX_HEADER: \def\@spart#1{%
#+LATEX_HEADER:   {\centering%
#+LATEX_HEADER:    \interlinepenalty \@M%
#+LATEX_HEADER:    \partfont\LARGE\MakeUppercase{#1}\par}%
#+LATEX_HEADER:   \@endpart}
#+LATEX_HEADER: \def\@endpart{\vfil\newpage%
#+LATEX_HEADER:   \if@twoside%
#+LATEX_HEADER:     \null%
#+LATEX_HEADER:     \thispagestyle{empty}%
#+LATEX_HEADER:     \newpage%
#+LATEX_HEADER:   \fi%
#+LATEX_HEADER:   \if@tempswa%
#+LATEX_HEADER:     \twocolumn%
#+LATEX_HEADER:   \fi}
#+LATEX_HEADER: \renewcommand{\@makechapterhead}[1]{%
#+LATEX_HEADER:   \vspace*{0.12\textheight}%
#+LATEX_HEADER:   {\parindent \z@ \raggedright
#+LATEX_HEADER:     \chapterfont\huge #1\par\nobreak
...
#+LATEX_HEADER:   \thispagestyle{plain}%
#+LATEX_HEADER: }
#+LATEX_HEADER: % Configure chapter marks for running heads
#+LATEX_HEADER: \renewcommand{\chaptermark}[1]{\markboth{#1}{}}
#+LATEX_HEADER: % Parts don't set marks
#+LATEX_HEADER: \renewcommand{\sectionmark}[1]{}
#+LATEX_HEADER: % Subsections don't set marks
#+LATEX_HEADER: \renewcommand{\subsectionmark}[1]{}
#+LATEX_HEADER: % Override chapter command to use plain style on opening pages
...
# =============================================================================
# FRONT MATTER - Professional Editorial Quality
# =============================================================================

#+LATEX: \frontmatter
#+LATEX: \pagestyle{empty}

# Half-title page (página i) - Minimal, elegant
#+LATEX: \thispagestyle{empty}
#+LATEX: \vspace*{0.25\textheight}
#+LATEX: \begin{center}
#+LATEX: {\chapterfont\Huge Crecer en Libertad}
#+LATEX: \end{center}
#+LATEX: \vspace*{\fill}
#+LATEX: \clearpage

# Blank page (página ii)
#+LATEX: \thispagestyle{empty}
#+LATEX: \mbox{}
#+LATEX: \clearpage

# Full title page (página iii) - Complete information
#+LATEX: \thispagestyle{empty}
#+LATEX: \vspace*{0.20\textheight}
#+LATEX: \begin{center}
#+LATEX: {\chapterfont\huge Crecer en Libertad}\\[0.8cm]
#+LATEX: {\large\itshape Otra forma de aprender es posible}\\
#+LATEX: \vspace{0.18\textheight}
#+LATEX: {\Large Juan Manuel Ferrera Díaz}\\
#+LATEX: \vspace*{\fill}
...
# Copyright page (página iv) - Legal and publication information
#+LATEX: \thispagestyle{empty}
#+LATEX: \vspace*{\fill}
...
- SinDerivadas: no puede distribuir el material si lo remezcla,\\
...
# Dedication page (página v) - To Yukari
#+LATEX: \thispagestyle{empty}
#+LATEX: \vspace*{0.30\textheight}
#+LATEX: \begin{center}
#+LATEX: \itshape
...
# Author's Note (página vi-vii) - Context for the reader
#+LATEX: \thispagestyle{empty}

#+LATEX: \vspace*{0.08\textheight}
#+LATEX: \begin{center}
#+LATEX: {\chapterfont\Large Nota del Autor}
#+LATEX: \end{center}
#+LATEX: \vspace{0.8cm}

#+LATEX: \setlength{\parindent}{1.5em}
...
#+LATEX: \textit{J.M.F.}\\
#+LATEX: \textit{Tenerife, 2025}
#+LATEX: \end{flushright}

#+LATEX: \clearpage

# Table of Contents (páginas viii-ix)
#+LATEX: \pagestyle{frontmatter}
#+LATEX: \tableofcontents
#+LATEX: \clearpage

# Start main matter - Arabic numbering, running heads
#+LATEX: \mainmatter
...
2010. Cinco años después de sacar a los niños del colegio. Los encuentros presenciales se habían vuelto irregulares—familias dispersas, dificultad de coordinar fechas, costos de transporte. Pero la necesidad de comunidad seguía ahí.
...
2012. Una madre nueva en el foro escribió: "Necesito evidencia. No puedo simplemente confiar. Necesito saber que esto funciona, que hay investigación, que no estoy experimentando con el futuro de mi hijo."
...
2012. El foro tenía ciento cincuenta familias. Las conversaciones eran cada vez más ricas, más profundas.
...
2013. El foro cumplió dos años. Doscientas familias registradas. Miles de posts. Cientos de conversaciones significativas.
...
2011. Sexto año educando en casa. El foro acababa de lanzarse, la comunidad empezaba a crecer, los niños prosperaban. Y entonces llegó la denuncia.
