...
#+LATEX_HEADER: % Chapter titles (sections in Org) positioned lower on page - professional style
#+LATEX_HEADER: \titleformat{\section}
#+LATEX_HEADER:   {\normalfont\Large\bfseries}% Format
#+LATEX_HEADER:   {}% Label
#+LATEX_HEADER:   {0pt}% Sep
#+LATEX_HEADER:   {\vspace*{0.25\textheight}}% Before-code: pushes title to 25% down the page
#+LATEX_HEADER: \titlespacing*{\section}{0pt}{0pt}{40pt}% No extra space before, 40pt after
#+LATEX_HEADER: \titlespacing*{\subsection}{0pt}{*3}{*2}
#+LATEX_HEADER: \titlespacing*{\subsubsection}{0pt}{*2.5}{*1.5}

# Prevent orphan section headings - controlled by titlespacing above
...
#+LATEX_HEADER: % Section spacing is controlled by titlespacing above (line 186)
