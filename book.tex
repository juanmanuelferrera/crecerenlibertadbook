...
\chapter{Parte 1: Fundamentos}
\label{sec:org59c1345}

\section{Introducción a la Crianza en Libertad}
\label{sec:org535051a}
...
\cleardoublepage
\section{Historia y Teoría de la Educación Alternativa}
\label{sec:orgb165d00}
...
\chapter{Parte 2: Práctica}
\label{sec:orgd3f9c7c}

\section{Estrategias y Herramientas Cotidianas}
\label{sec:org28208b4}
...
\cleardoublepage
\section{Navegando la Presión Social y las Críticas}
\label{sec:org8e421b2}
...
\chapter{Parte 3: Inspiración y Futuro}
\label{sec:orgaf444d3}

\section{Historias de Éxito: Familias que lo Lograron}
\label{sec:org420278a}
...
\cleardoublepage
\section{El Futuro de la Educación: Tu Papel en el Cambio}
\label{sec:org738918c}

\subsection{Visión de un Futuro Educativo Alternativo}
\label{sec:orgcbf0471}
...
\subsection{Compromiso con la Crianza Consciente}
\label{sec:orgd3f1c39}
...
\subsection{Cómo Contribuir al Movimiento de Crianza en Libertad}
