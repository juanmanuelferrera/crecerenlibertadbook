...
\newfontfamily\partfont{Libertinus Sans}[
Scale=1.2,
LetterSpace=15,
UprightFont={* Light},
BoldFont={* SemiBold}
]
\newfontfamily\chapterfont{Libertinus Serif}[
Numbers=Lining,
...
\usepackage{setspace}
\setstretch{1.15}     % Professional line spacing for readability
...
\hyphenation{unschoo-ling homeschoo-ling des-esco-la-ri-zar des-esco-la-ri-za-ción edu-ca-ción so-cia-li-za-ción au-to-no-mía cu-rio-si-dad res-pon-sa-bi-li-dad}
\usepackage{xcolor}
\usepackage{graphicx}
\usepackage{fancyhdr}
...
% Compact TOC spacing using native LaTeX commands
\makeatletter
...
\fancyhf{}%
% Page numbers on outside edges (modern clean look)
\fancyfoot[LE]{\small\thepage}%
\fancyfoot[RO]{\small\thepage}%
% Running heads on inside (verso: author, recto: title)
\fancyhead[RO]{\small\itshape\nouppercase{\leftmark}}%
\fancyhead[LE]{\small\itshape Crecer en Libertad}%
% No rules - clean modern look
\renewcommand{\headrulewidth}{0pt}%
\renewcommand{\footrulewidth}{0pt}%
}
...
% Custom Part formatting - always start on odd page
\renewcommand{\@part}[2][]{%
\cleardoublepage%
\thispagestyle{empty}%
\null\vfil%
...
{\centering%
\interlinepenalty \@M%
\partfont\LARGE\MakeUppercase{#2}\par}%
\@endpart}
\def\@spart#1{%
{\centering%
\interlinepenalty \@M%
\partfont\LARGE\MakeUppercase{#1}\par}%
\@endpart}
\def\@endpart{\vfil\newpage%
\if@twoside%
\null%
...
% Configure chapter marks for running heads
\renewcommand{\chaptermark}[1]{\markboth{#1}{}}
% Parts don't set marks
\renewcommand{\sectionmark}[1]{}
% Subsections don't set marks
\renewcommand{\subsectionmark}[1]{}
% Override chapter command to use plain style on opening pages
...
\date{Primera Edición, 2025}
\title{Crecer en Libertad v.1.1\\\medskip
\large Otra forma de aprender es posible}
\hypersetup{
 pdfauthor={Juan Manuel Ferrera Díaz},
 pdftitle={Crecer en Libertad v.1.1},
 pdfkeywords={},
 pdfsubject={},
...
\begin{center}
{\chapterfont\Huge Crecer en Libertad}
\end{center}
\vspace*{\fill}
\clearpage
...
\begin{center}
{\chapterfont\huge Crecer en Libertad}\\[0.8cm]
{\large\itshape Otra forma de aprender es posible}\\
\vspace{0.18\textheight}
{\Large Juan Manuel Ferrera Díaz}\\
\vspace*{\fill}
{\normalsize Primera Edición}\\[0.4cm]
{\normalsize 2025}
\end{center}
\clearpage
...
\textbf{Crecer en Libertad}\\
\emph{Otra forma de aprender es posible}
...
Usted es libre de compartir — copiar y redistribuir el material\\
en cualquier medio o formato bajo las siguientes condiciones:
\begin{itemize}
\item Reconocimiento: debe dar crédito de manera adecuada
\item NoComercial: no puede utilizar el material con fines comerciales
\item SinDerivadas: no puede distribuir el material si lo remezcla,\\
transforma o crea a partir de él
\end{itemize}

Los nombres y detalles de algunas personas han sido modificados\\
para proteger su privacidad.

Las opiniones expresadas en este libro son las del autor y\\
no necesariamente reflejan las de ninguna organización.
...
Para Yukari,\\
que nos enseñó a vivir con valentía\\
y morir con gracia

\vspace{0.5cm}

Y para Arjuna y Nitai,\\
que me enseñaron todo lo demás
...
\begin{center}
{\chapterfont\Large Nota del Autor}
\end{center}
\vspace{0.8cm}
...
\mainmatter
\pagestyle{fancy}
\chapter{PARTE I: EL PARAÍSO}
\label{sec:orgf8c3fb3}

\section{Capítulo 1: La Semilla}
\label{sec:orgf86fe56}
...
El director miró hacia los niños jugando. Luego me miró a mí. "Porque creo que eres el tipo de persona que puede manejarlo. Hay ideas aquí que\ldots{} bueno, son difíciles. Cuestionan las bases de lo que hacemos en las escuelas. Pero son ideas honestas."
...
Gatto describía el origen de las escuelas modernas—no como lugares de aprendizaje sino como lugares de \emph{control}. Diseñadas en Prusia para crear soldados obedientes, obreros dóciles, ciudadanos que no cuestionaran. Exportadas al mundo entero como si fueran progreso.
...
\emph{Por si hace falta,} pensé. \emph{Por si alguna vez hace falta.}
...
\begin{center}* * *\end{center}
\section{Capítulo 2: Sobrevivir}
\label{sec:org6ca6fc8}
...
A veces sacaba \emph{Dumbing Us Down} del cajón y releía párrafos. No todo—era demasiado denso, demasiado provocador para digerir en un banco de parque con dos niños gritando cerca. Pero fragmentos. Ideas que resonaban y luego lo guardaba de nuevo.
...
No era infelicidad, exactamente. Era\ldots{} agotamiento funcional. Sobrevivir no es vivir, pero cuando eres un viudo solo en país extranjero con dos niños pequeños, sobrevivir es suficiente logro.
...
Yo conservaba \emph{Dumbing Us Down} en mi mochila, junto con nuestra ropa, documentos y las pocas pertenencias que cabían en dos maletas.
...
\section{Capítulo 3: La Barrera del Idioma}
\label{sec:org79c0918}
...
Arjuna intentaba. Escuchaba intensamente, capturaba palabras, preguntaba "¿qué significa\ldots{}?" cincuenta veces al día. Nitai se cerró. Se volvió más callado. Respondía en inglés incluso cuando le hablaban en español, como si negarse a usar el idioma pudiera devolvernos a Australia.
...
Y honestamente, parte de mí pensaba: \emph{Tenerife es España. Las escuelas españolas son más relajadas, más humanas que las escuelas anglosajonas. Será diferente a Australia pero no peor.}
...
"Cuando abra la mano," expliqué, "tienen que gritar el color en español. \emph{Rojo}. Pero rápido—antes de que cierre el puño otra vez. Si llegan tarde, pierden."

Abrí la mano. Flash de rojo.

Silencio. Los niños miraron confundidos.

"Rojo," dije. "En español es \emph{rojo}. Otra vez."

Repetimos. Esta vez, cuando abrí la mano, Arjuna gritó: "\emph{¡Rojo!}"

"Bien. Ahora este." Cerré el puño con el azul. Abrí rápido.

"\emph{Blue}," gritó Nitai.

"No, no. En español. \emph{Azul.}"

"\emph{Azul}," repitió.

"Más rápido. Antes de que cierre la mano."

Lo hicimos veinte veces. Cuatro colores, velocidad aumentando. Pronto estaban compitiendo—quien gritaba primero ganaba un punto imaginario. Rojo, azul, verde, amarillo. \emph{Rojo, azul, verde, amarillo.} Una y otra vez hasta que los colores se volvieron automáticos, reflejos, sin traducir al inglés primero.
...
"Dice que preste atención. Pero \emph{estoy} prestando atención. Solo que no entiendo las palabras."
...
\emph{Libro. Cuaderno. Lápiz. Siéntate. Ven aquí. Cállate.}

Especialmente esa última. \emph{Cállate.} La primera palabra que Arjuna aprendió sin que yo se la enseñara, porque la maestra la repetía veinte veces al día.
...
Estaban cambiando. No solo aprendiendo palabras, sino \emph{adaptándose al sistema}. Aprendiendo que los adultos mandan sin explicación. Que debes sentarte quieto incluso si tu cuerpo necesita moverse. Que las preguntas molestan. Que la obediencia es más valorada que la curiosidad.
...
\chapter{PARTE II: LA CRISIS}
\label{sec:orgd7efd1b}

\section{Capítulo 4: El Quiebre}
\label{sec:orgeeea385}
...
Yo no sabía qué responder. Porque la pregunta real no era si estaba bien. La pregunta real era: \emph{¿Me van a castigar si no está bien?}
...
"No sé," dijo Arjuna. Su voz era débil. Rota. "Ella dijo que lo había hecho mal. Que no escuché las instrucciones. Pero yo \emph{sí} escuché. Hice lo que dijo. Pero ella dijo que estaba mal."

"¿Te explicó qué estaba mal?"

"No. Solo dijo 'hazlo de nuevo.' Y lo rompió. Delante de todos."

Ahí estaba. Esa última parte. \emph{Delante de todos.}
...
Porque esa noche, después de acostar a Arjuna y Nitai, saqué \emph{Dumbing Us Down} del cajón donde había estado guardado desde Australia.
...
\emph{"El daño que las escuelas hacen es doble,"} continué leyendo. \emph{"A los niños que fracasan, obviamente, pero también a los que triunfan, porque les enseñan que su valor depende de la aprobación externa, que deben competir constantemente, que deben obedecer sin cuestionar."}
...
Gatto ya no era teoría abstracta leída en la penumbra de una madrugada australiana. Era esto. Esto que me estaba sucediendo \emph{a mí}. A \emph{mis hijos}.
...
\section{Capítulo 5: La Salida}
\label{sec:org1b3f1dc}
...
"Las tablas son importantes. Las necesitas para\ldots{}"
...
"¿Pero\ldots{} qué tenemos que hacer?"
...
Recordaba a Gatto vagamente. Pero Gatto hablaba de escuelas, no de qué hacer \emph{después} de salir de ellas. No tenía manual. No tenía guía. Solo tenía dos niños y una fe temblorosa de que esto tenía que ser mejor que lo anterior.
...
\section{Capítulo 6: Lo Que Surgió}
\label{sec:orgf69b5d2}
...
\chapter{PARTE III: EL CAMINO}
\label{sec:org0826f7c}

\section{Capítulo 7: La Vida Diaria}
\label{sec:orge7db07a}

\begin{enumerate}
\item Un año después de sacar a los niños del colegio. Seguíamos viviendo en la casa enorme del abuelo en el pueblo cercano a La Laguna. La tía también vivía allí. Tres generaciones bajo un mismo techo. Espacio suficiente para todos.
\end{enumerate}
...
Miró el mapa. "Quince kilómetros. El autobús va a cuarenta kilómetros/hora. Entonces\ldots{} media hora."
...
"¿Pero\ldots{} tienes un currículo? ¿Sigues el programa oficial?"
...
Ella intentó ser educada. "Suena\ldots{} interesante."
...
\begin{center}* * *\end{center}
\section{Capítulo 8: Crecer en Libertad}
\label{sec:org9573780}

\begin{enumerate}
\item Dos años después de sacar a los niños del colegio. Los encuentros presenciales se habían vuelto irregulares—familias dispersas, dificultad de coordinar fechas, costos de transporte. Pero la necesidad de comunidad seguía ahí.
\end{enumerate}
...
\begin{itemize}
\item Primeros pasos (para familias nuevas)
\item Legalidad (compartiendo experiencias con inspecciones, denuncias)
\item Recursos (libros, páginas web, materiales)
\item Día a día (anécdotas, desafíos prácticos, celebraciones)
\item Filosofía educativa (Gatto, Holt, Illich, debates profundos)
\end{itemize}
...
\begin{enumerate}
\item Una madre nueva en el foro escribió: "Necesito evidencia. No puedo simplemente confiar. Necesito saber que esto funciona, que hay investigación, que no estoy experimentando con el futuro de mi hijo."
\end{enumerate}
...
Pensé en Nitai aprendiendo a leer solo. En Arjuna descifrando cómo funcionaban las cosas. Nadie les había enseñado a \emph{aprender}. Lo traían incorporado. La escuela solo había interferido con ese proceso natural.
...
\begin{itemize}
\item La mayoría reportaba infancias felices, sin arrepentimientos
\item No había déficit en socialización—de hecho, muchos reportaban mejor capacidad para relacionarse con personas de todas las edades
\item Más del 80\% había ido a universidad si querían, y les iba bien
\item Muchos eran emprendedores, creativos, trabajadores independientes
\item Común entre todos: autonomía, autodirección, confianza en su capacidad de aprender
\end{itemize}
...
\begin{enumerate}
\item El foro tenía ciento cincuenta familias. Las conversaciones eran cada vez más ricas, más profundas.
\end{enumerate}
...
\begin{enumerate}
\item El foro cumplió dos años. Doscientas familias registradas. Miles de posts. Cientos de conversaciones significativas.
\end{enumerate}
...
\begin{enumerate}
\item Tercer año educando en casa. El foro iba bien, la comunidad crecía, los niños prosperaban. Y entonces llegó la denuncia.
\end{enumerate}
...
"¿Debería tener\ldots{} no sé, portafolio de trabajos? ¿Evidencia de aprendizaje?"
...
"Leyendo," respondió Arjuna, mostrando su libro. \emph{Percy Jackson}, en inglés.
...
Doblé la carta rápidamente. "Nada. Solo\ldots{} correspondencia del gobierno. Trámites."
...
¿Podían hacer eso? ¿Simplemente\ldots{} quitarme a mis hijos porque no iban al colegio?
...
"Tengo que verme\ldots{} presentable."

"¿Cuándo vuelves?"

"Al mediodía, probablemente."

"¿Y si\ldots{}?" Arjuna no terminó la pregunta.
...
"Las trabajadoras sociales informaron que las condiciones materiales eran\ldots{} adecuadas. Pero eso no cambia el hecho de que están incumpliendo la ley de escolarización."
...
"La madre de los niños falleció hace\ldots{} cuatro años."
...
Y continuamos.
\section{Capítulo 9: Lérida}
\label{sec:orgb3c3e0b}
...
"Pensé que estábamos solos," dijo. "Pensé que éramos los únicos raros. Y ahora estoy aquí, con veinte familias, y todos\ldots{} todos están haciendo lo mismo. No estamos locos."
...
"¿Y la escuela habría\ldots{}?" empezó la madre.
...
Una madre escribió en el foro: "Volví de Lérida con energía renovada. Había empezado a dudar—¿estoy haciendo lo correcto? Pero ver a tantas familias, ver niños felices de todas las edades, ver adolescentes articulados y seguros\ldots{} ya no tengo dudas."
...
"Que lo que hacemos no es raro. El colegio es raro. Sentarse en sillas seis horas es raro. Hacer exámenes sobre cosas que no te importan es raro. Nosotros solo estamos\ldots{} viviendo normalmente. Aprendiendo de la vida. Eso es lo natural."
...
\chapter{PARTE IV: LA MADURACIÓN}
\label{sec:org8aef3f9}

\section{Capítulo 10: Adolescencia}
\label{sec:orgdd1e0bc}
...
"Pero\ldots{} todos los niños tienen deberes. Es parte del currículo."
...
"Ecuaciones cuadráticas. Llevo tres días con esto. No\ldots{} no puedo."
...
"¿Un tutor? Eso es\ldots{} traicionar el unschooling."
...
"Pareces\ldots{} desconectado."

Se encogió de hombros. "No sé qué quiero hacer."

"¿Con tu vida?"

"Con nada. Con hoy. Con mañana. Solo estoy\ldots{} aquí."
...
Arjuna sosteniendo la cámara. Nitai en posición de ataque, manos juntas a un lado como preparando\ldots{} algo.
...
"No sé. Simplemente\ldots{} hablamos. Como personas."
...
\section{Capítulo 11: El Resultado}
\label{sec:orgc37a499}

\begin{enumerate}
\item Casi veinte años desde que saqué a los niños del colegio.
\end{enumerate}
...
"Traté de explicar. Que estudiaba lo que me interesaba, que aprendía música, que tenía proyectos online. Se rio. No cruel—solo\ldots{} incrédulo."
...
\begin{center}* * *\end{center}
\section{Los Libros que Me Acompañaron}
\label{sec:org70848ea}

Hubo libros que marcaron este camino. No muchos—pero los precisos.

\emph{Dumbing Us Down} de John Taylor Gatto. El que empezó todo. Delgado, furioso, honesto. Un maestro de Nueva York renunciando después de treinta años y diciendo verdades que el sistema no quiere oír.

\emph{How Children Fail} de John Holt. Más gentil donde Gatto era brutal. Observación calmada de un maestro que vio cómo la escuela destruía niños brillantes y decidió que tenía que haber otra forma.

\emph{Deschooling Society} de Ivan Illich. Más denso. Más filosófico. Me costó dos lecturas entenderlo completamente. Pero su propuesta—desescolarizar no solo a los niños sino a la sociedad entera—era radical y necesaria.

\emph{Free to Learn} de Peter Gray. El científico. El que tenía evidencia cuando yo necesitaba más que fe. Estudios sobre niños que aprendían jugando, familias unschoolers cuyos hijos prosperaban sin instrucción formal.
...
Pero él continuó: "¿Podrías hablar conmigo? Mi hija\ldots{} está sufriendo. No quiere ir. Llora cada mañana. Y yo no sé qué hacer. Pensé\ldots{} quizá tú sabes algo que yo no sé."
