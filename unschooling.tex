...
\usepackage{titlesec}
% Chapter titles (sections in Org) positioned lower on page - professional style
\titleformat{\section}
{\normalfont\Large\bfseries}% Format
{}% Label
{0pt}% Sep
{\vspace*{0.25\textheight}}% Before-code: pushes title to 25% down the page
\titlespacing*{\section}{0pt}{0pt}{40pt}% No extra space before, 40pt after
...
% Section spacing is controlled by titlespacing above (line 186)
...
\label{sec:orgc90118a}

\cleardoublepage
\section{Capítulo 1: La Semilla}
\label{sec:org1be16d5}
...
A veces sacaba \emph{Dumbing Us Down} y releía párrafos. No todo—era demasiado denso, demasiado provocador para digerir en un banco de parque con dos niños gritando cerca. Pero fragmentos. Ideas que resonaban y luego lo guardaba de nuevo.
...
\label{sec:orgbd62965}

\cleardoublepage
\section{Capítulo 4: El Quiebre}
\label{sec:org3daa42f}
...
\label{sec:orgaabef03}

\cleardoublepage
\section{Capítulo 7: La Vida Diaria}
\label{sec:org8e6120f}
...
\label{sec:org6dd6bfc}

\cleardoublepage
\section{Capítulo 10: Adolescencia}
\label{sec:orgbf72404}
